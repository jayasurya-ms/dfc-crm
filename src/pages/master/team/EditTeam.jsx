...
const EditTeam = () => {
  ...
  const fetchEditTeam = async () => {
    try {
      ...
      console.error("Error fetching  team  edit master data", error);
    } finally {
      setLoading(false);
    }
  };
  const fetchCompany = async () => {
    try {
      ...
      console.error("Error fetching edit team master data", error);
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    data.append("user_status", team.user_status);
